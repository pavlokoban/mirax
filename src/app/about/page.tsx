    ...
    <section className="py-32">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <p className="text-lg opacity-80 leading-relaxed mb-16">
          Миракс — это команда специалистов, которая разрабатывает сайты
          для людей с продуманным UI/UX и одновременно учитывает требования
          современных ИИ-систем: Яндекс Алисы, ChatGPT, Gemini и других.
          <br /><br />
          Мы создаём сайты, которые работают не по устаревшим SEO-шаблонам,
          а ориентируются на реальные запросы пользователей и логику
          машинного понимания контента.
        </p>
